...
- `06_add_module_score.R`
- `07_milor_differential_abundance.R`
- `08_screpertoire_tcr_analysis.R`
- `09_monocle_pseudotime.R`
- `10_cellchat_communication.R`
- `11_scmetabolism_analysis.R`
- `12_nmf_program_discovery.R`
- `13_meta_program_analysis.R`
- `14_scenic_regulatory_network.R`
- `15_cellphonedb_visualization.R`

## Main outputs

| Script | Main outputs |
| --- | --- |
| `01_seurat_integration.R` | `scRNA_end.rds` |
| `02_umap_visualization.R` | `Dimplot_scRNA.pdf` |
| `04_roe_analysis.R` | `Roe_result.rds` |
| `07_milor_differential_abundance.R` | `miloR_UMAP.pdf`, `miloR_DA.pdf` |
| `08_screpertoire_tcr_analysis.R` | `cloneType.pdf`, `CD8TCR_occupiedscRepertoire_table.csv` |
| `09_monocle_pseudotime.R` | `Pseudotime_celltype.pdf` |
| `10_cellchat_communication.R` | multiple CellChat comparison plots |
| `11_scmetabolism_analysis.R` | `cDC_scMetabolism_type.rds` |
| `12_nmf_program_discovery.R` | `res_nmf_sampleX.rds` |
| `13_meta_program_analysis.R` | `Robust_NMF_MP.pdf`, `MP_list.rds` |
| `14_scenic_regulatory_network.R` | `TF_specific.pdf`, `cDC_SCENIC_regulonRSS.csv` |
| `15_cellphonedb_visualization.R` | `npc_project_merge.txt`, `npc_project_filt.txt`, `CellphoneDB_bubble.pdf` |
